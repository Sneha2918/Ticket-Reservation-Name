...
public class AdminAddTrain extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
		...
		try {
			...
			train.setDeparture(req.getParameter("departure").toUpperCase());
			train.setDestination(req.getParameter("destination").toUpperCase());
			train.setTotalseats(Integer.parseInt(req.getParameter("available")));
			train.setTotalfare(Double.parseDouble(req.getParameter("fare")));
