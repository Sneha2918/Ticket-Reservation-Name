		...
		try {
			...
			if (trains != null && !trains.isEmpty()) {
				...
				pw.println("<div class='tab'><table><tr><th>Train Name</th><th>Train Number</th>"
						+ "<th>Departure</th><th>Destination</th><th>Time</th><th>Total Seats Available</th><th>Total Fare(INR)</th><th>Booking</th></tr>");
				...
				RequestDispatcher rd = req.getRequestDispatcher("UserViewTrains.html");
				rd.include(req, res);
				pw.println("<div class='main'><p1 class='menu red'> No Ongoing Trains</p1></div>");
			}
		} catch (Exception e) {
