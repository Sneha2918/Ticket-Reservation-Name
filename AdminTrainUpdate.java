		...
		try {
			...
			if (train != null) {
				...
				pw.println("<div class='tab'>" + "<table><form action='updatetrainschedule' method='post'>"
						...
						+ "<tr><td>Departure:</td><td><input type='text' name='fromstation' value='"
						+ train.getDeparture() + "'></td></tr>"
						+ "<tr><td>Destination:</td><td><input type='text' name='tostation' value='" + train.getDestination()
						+ "'></td></tr>"
						+ "<tr><td>Total Available seats:</td><td><input type='text' name='available' value='"
						+ train.getTotalseats() + "'></td></tr>"
						+ "<tr><td>Fare (INR) :</td><td><input type='text' name='fare' value='" + train.getTotalfare()
						+ "'></td></tr>"
