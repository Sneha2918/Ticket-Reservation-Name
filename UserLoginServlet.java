...
public class UserLoginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
		...
		String responseMsg = TrainUtil.login(req, res, UserRole.CLIENT, userName, passWord);
		if (ResponseCode.SUCCESS.toString().equalsIgnoreCase(responseMsg)) {
			...
			pw.println("<div class='tab'>Greetings " + uName
					+ " ! Thanks for checking in.<br/> Here you can Check up the train "
					+ "details and train schedule,fare Enquiry and many more information.<br/>Just go to the Side Menu Links and "
					+ "Explore the Advantages.<br/><br/>Thank you! Will keep you updated" + "</div>");
